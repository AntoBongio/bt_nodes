...
class CallServiceExample : public BT::SyncActionNode
{
public:
  using Trigger = std_srvs::srv::Trigger;

    CallServiceExample(const std::string& name, const BT::NodeConfiguration& config)
        : BT::SyncActionNode(name, config)
    {
        node_ = rclcpp::Node::make_shared("call_service_example_bt");
        ...
        RCLCPP_INFO(node_->get_logger(), "CallServiceExample - init");
    }
